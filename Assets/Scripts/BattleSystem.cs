...
public class BattleSystem : MonoBehaviour
{
    ...
    void Start()
    {
        spells = new List<Spell>()
        {
            ...
            new Spell("Frostbite", 40, true, true),
    ...
    {
        yield return StartCoroutine(dialogBox.TypeDialog($"You used {spell.Name}!"));
    ...
    private IEnumerator BossTurn()
    {
        ...
        yield return StartCoroutine(dialogBox.TypeDialog($"Boss used {chosenSpell.Name}!"));
        yield return new WaitForSeconds(1f);
    ...
    private void ApplySpellEffects(BattleUnit caster, BattleUnit target, Spell spell)
    {
        ...
        target.ApplySpellEffect(spell, caster);
        caster.ApplySpellEffect(spell, caster);
